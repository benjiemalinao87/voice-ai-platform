...
export function AiFlowChat({ isOpen, onClose, onFlowGenerated }: AiFlowChatProps) {
  ...
  return (
    <div className="w-96 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 flex flex-col h-full shadow-xl animate-in slide-in-from-right duration-300">
      {/* Header */}
