-- Migration: Add Salesforce Integration Support
-- Description: Adds OAuth token storage and sync logging for Salesforce integration
-- Date: 2025-11-05

-- ============================================
-- 1. Add Salesforce OAuth columns to workspace_settings
-- ============================================
...
-- Salesforce OAuth access token (expires in ~2 hours)
ALTER TABLE workspace_settings ADD COLUMN salesforce_access_token TEXT;

-- Salesforce OAuth refresh token (long-lived, used to get new access tokens)
